local OrionLib = loadstring(game:HttpGet("https://pastebin.com/raw/x5g4ZzL6"))()
...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青脚本"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青脚本"; Text ="3"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青脚本"; Text ="2"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青脚本"; Text ="1"; Duration = 2; })wait("1")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青脚本"; Text ="载入成功"; Duration = 3; })
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/roblox-ye/QQ515966991/refs/heads/main/yeui.lua"))()
local window = library:new("神青脚本内置")
...
local function HeartbeatUpdate()
	...
	local CurrentFPS = (tick() - Start >= 1 and #FrameUpdateTable) or (#FrameUpdateTable / (tick() - Start))
	CurrentFPS = CurrentFPS - CurrentFPS % 1
	FpsLabel.Text = ("神青:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S")).."秒"
end
Start = tick()
...
local abouthubb = UITab4:section("内容",true)

abouthubb:Button("范围10", function()
...
abouthubb:Button("范围20", function()
...
abouthubb:Button("范围30", function()
...
abouthubb:Button("范围40", function()
...
abouthubb:Button("范围50", function()
...
abouthubb:Button("范围60", function()
...
abouthubb:Button("范围70", function()
...
abouthubb:Button("范围80", function()
...
abouthubb:Button("范围90", function()
...
abouthubb:Button("范围100", function()
...
abouthubb:Button("范围150", function()
...
abouthubb:Button("范围200", function()
...
abouthubb:Button("范围250", function()
...
abouthubb:Button("范围300", function()
