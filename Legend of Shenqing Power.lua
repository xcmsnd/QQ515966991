...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青力量传奇"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青力量传奇"; Text ="3"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "欢迎使用"; Text ="2"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "感谢支持"; Text ="1"; Duration = 2; })wait("1")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "神青力量传奇"; Text ="载入成功"; Duration = 3; })local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/roblox-ye/QQ515966991/refs/heads/main/yeui.lua"))()
local window = library:new("神青力量传奇脚本")
...
local creds = window:Tab("公告",'7733993211')
    ...
    bin:Label("缝合脚本")
    bin:Label("不能外传，不能诋毁")
    local creds = window:Tab("自动", "6035145364")
    local credits = creds:section("自动内容", true)
...
local creds = window:Tab("传送跑步机", "6035145364")
...
local creds = window:Tab("传送到石头", "6035145364")
    local credits = creds:section("传送内容", true)
...
local creds = window:Tab("传送地图", "6035145364")
    local credits = creds:section("传送内容", true)
