...
function library.new(library, name, theme)
	...
	local config = {
		...
		Dropdown_Color = Color3.fromRGB(0, 4, 21),
		Keybind_Color = Color3.fromRGB(0, 4, 21),
		Label_Color = Color3.fromRGB(0, 4, 21),

		Slider_Color = Color3.fromRGB(0, 4, 21),
		SliderBar_Color = Color3.fromRGB(0, 105, 113),

		Toggle_Color = Color3.fromRGB(0, 4, 21),
		Toggle_Off = Color3.fromRGB(128, 139, 148),
		Toggle_On = Color3.fromRGB(0, 167, 250),
	}
	...
	ScriptTitle.TextColor3 = Color3.fromRGB(30, 185, 140)
