...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "叶脚本"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "叶脚本"; Text ="3"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "叶脚本"; Text ="2"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "叶脚本"; Text ="1"; Duration = 2; })wait("1")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "叶脚本"; Text ="载入成功"; Duration = 3; })
...
about:Button("自然灾害6",function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/MrWitzbold/Natural-disaster-survival-GUI/main/main.lua'),true))()
end)

about:Button("自然灾害7",function()
...
about:Button("举重模拟器3",function()
loadstring(game:HttpGet("https://scriptblox.com/raw/OP-50x-EVENT-Muscle-Lifting-Simulator-NEW!-Infinite-s-n-Infinite-Gems-and-more-7852"))()
end)

about:Button("举重模拟器4",function()
...
about:Button("破坏者谜团2  2",function()
loadstring(game:GetObjects("rbxassetid://4001118261")[1].Source)()
end)

about:Button("破坏者谜团2  3",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Ihaveash0rtnamefordiscord/Releases/main/MurderMystery2HighlightESP"))(' Watermelon ?')
end)

about:Button("破坏者谜团2  4",function()
...
about:Button("动感星期五6",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/wally-rblx/funky-friday-autoplay/main/main.lua",true))()
end)

about:Button("动感星期五7",function()
loadstring(game:HttpGet("https://scriptblox.com/raw/XMAS-Event-or-Funky-Friday-Auto-Player-Mobile-6721"))()
end)
...
local UITab71 = win:Tab("『一个普通的露营故事』",'7734068321')
...
local UITab71 = win:Tab("无名射手",'7734068321')
...
local UITab72 = win:Tab("『亡灵防御大亨』",'7734068321')

local about = UITab72:section("『亡灵防御大亨』",true)

about:Button("亡灵防御大亨",function()
loadstring(game:HttpGet"https://thedragonslayer2.github.io/AutoExec.html")()
end)

local UITab74 = win:Tab("『模仿者』",'7734068321')

local about = UITab74:section("『模仿者』",true)
...
local UITab76 = win:Tab("『入侵者』",'7734068321')

local about = UITab76:section("『入侵者』",true)

about:Button("入侵者1",function()
